...
// }
//
// void				polish_weapon(t_duel *duel)
// {
// 	int x;
// 	int y;
// 	int	tmp;
...
// 	{
// 		if (duel->weapon[y][x] == -1 && duel->weapon[y + 1][x])
// 		{
// 			tmp
// 			while (x + 1 < duel->weapon[0][1]) //go through all columns
// 			{
// 				y = 0;
// 				while (y < duel->weapon[0][0]) //move them up
// 				{
// 					duel->weapon[y][x] = duel->weapon[y + 1][x];
// 					y++;
// 				}
// 				x++;
// 			}
...
// 			y++;
// 	}
// 	polish_weapon(); //here you remove the -1 lines.
// }

//you are going to so much fucking effort to make the weapon array smaller
//but it might not even be nessecary
//just fuckin try without it
